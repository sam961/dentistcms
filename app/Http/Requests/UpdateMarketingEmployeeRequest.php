...
class UpdateMarketingEmployeeRequest extends FormRequest
{
    /**
    ...
    {
        $employeeId = $this->route('marketing_employee');

        return [
            'name' => ['required', 'string', 'max:255'],
            'email' => ['required', 'email', 'max:255', 'unique:marketing_employees,email,'.$employeeId],
            'phone' => ['nullable', 'string', 'max:50'],
            'employee_code' => ['required', 'string', 'max:50', 'unique:marketing_employees,employee_code,'.$employeeId],
