                ...
                <div class="flex flex-col gap-6">
                    ...
                    <div class="flex flex-col xl:flex-row gap-6">
                        ...
                        <div class="flex-1">
                            ...
                            <button @click="selectedStatus = 'scheduled'; applyFilters()"
                                    :class="selectedStatus === 'scheduled' ?
                                        'bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-lg transform scale-105' :
                                        'bg-blue-50 text-blue-700 border-2 border-blue-200 hover:border-blue-400 hover:bg-blue-100'"
                                    class="inline-flex items-center px-4 py-2 rounded-full text-sm font-medium transition-all duration-200 cursor-pointer">
                                <div class="w-2 h-2 rounded-full mr-2" :class="selectedStatus === 'scheduled' ? 'bg-white' : 'bg-blue-500'"></div>
                                Scheduled
                                <span class="ml-2 px-2 py-0.5 text-xs rounded-full"
                                      :class="selectedStatus === 'scheduled' ? 'bg-white/20 text-white' : 'bg-blue-100 text-blue-700'">
                                    ...
                                    <td class="px-6 py-4">
                                        <span class="inline-flex items-center px-3 py-1 rounded-xl text-xs font-semibold 
                                            ...
                                            <div class="w-2 h-2 rounded-full mr-2 
                                                ...
                                                @elseif($appointment->status === 'scheduled') bg-blue-500
